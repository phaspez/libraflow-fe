...
const isInPast = (date: DateValue, currentDate: CalendarDate) => {
	return date.compare(currentDate) < 0
}

const isDateUnavailable = (date: DateValue) => {
	const currentDate = today(getLocalTimeZone())
	return !isInPast(date, currentDate)
}
...
const formatter = useDateFormatter('vi')
</script>
				...
				<CalendarGridBody class="grid">
					...
					>
						<CalendarCell
							...
							:date="weekDate"
							:disabled="isDateUnavailable(weekDate)"
						>
