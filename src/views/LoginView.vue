...
<template>
	<div class="view-container">
		<div class="fixed right-0 top-0 -z-10 md:z-0 h-screen img">
...
<style scoped>
.img {
	@apply overflow-hidden w-full md:w-1/3 lg:w-1/2 md:brightness-100 md:opacity-100 brightness-50 opacity-20;
}
</style>
